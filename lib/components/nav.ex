defmodule GerbileImv.Component.Nav do
  ...
  def init(scene, current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           {"Sensor", GerbileImv.Scene.Sensor},
           {"Sensor (spec)", GerbileImv.Scene.SensorSpec},
           {"Primitives", GerbileImv.Scene.Primitives},
           {"Fills", GerbileImv.Scene.Fills},
           {"Strokes", GerbileImv.Scene.Strokes},
           {"Components", GerbileImv.Scene.Components},
           ...
           {"Crop", GerbileImv.Scene.ImageCrop},
